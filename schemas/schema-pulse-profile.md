...
|-------|------|----------|---------|------------|
| type | String | Yes | — | Pulse Profile |
| schema | String | Yes | — | pulse-profile |
| created | Date | Yes | — | YYYY-MM-DD |
| updated | Date | Yes | — | YYYY-MM-DD — advances on every edit (typos, phrasing, content). |
...
| description | String | Yes | — | One-line summary of current direction. |
...
| §3.0 Domain Interests | Table | Yes | — | replace | Your domain enum, as a keyed table. Dual-purpose — drives Layer 1 inclusion AND L1 classifier domain-tagging; the report's per-domain sections reference these keys. Keep it small and stable; changes are version-bump events. |
